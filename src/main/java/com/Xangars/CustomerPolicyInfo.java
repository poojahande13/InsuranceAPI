        ...
        try {
            ...
            for(int i = 0; i<jsonarr.size();i++) {
                ...
                try{
                    ...
                    if (recordFound){
                     policydetails.setMESSAGE("Policy Number Found In Insurance Database");
                     policydetails.setStatus(1006);
                    }else{
                        policydetails.setMESSAGE("Policy Number Not Found In Insurance Database");
                        policydetails.setStatus(400);
                    }
                    con.close();
